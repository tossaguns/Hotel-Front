            ...
            <div>
                ...
                <div class="flex justify-center space-x-5 mb-2 bg-white mt-2 py-4 rounded-lg px-2">
                    <div class="flex space-x-2">
                        ...
                        <input class="border rounded-md px-2 py-1 text-sm" />
                    </div>
                    <div>
                ...
                <div class="bg-white rounded-lg pb-6 pt-4">
                    <div class="flex justify-center py-4">
                        <p class="text-4xl font-bold text-red-600">ปฏิเสธ</p>
                    </div>
                        ...
                        <table class="w-full border border-collapse text-xs md:text-sm">
                            <thead>
                                <tr class="bg-gray-200 whitespace-nowrap">
                                    ...
                                    <th class="border px-2 py-1">โลโก้</th>
                            ...
                            <tbody>
                                <tr v-for="(partner, index) in paginatedData" :key="partner._id"
                                    ...
                                    <td class="border px-2 py-1 text-center">
                                        <button @click="navigateToDetailPartner(partner._id, index + 1, 'rejected')"
