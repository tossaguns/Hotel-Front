            ...
            <div>
                ...
                <div class="bg-white rounded-lg pb-6 pt-4">
                    <div class="flex justify-center py-4">
                        <p class="text-2xl md:text-4xl font-bold text-amber-400">ดำเนินการเเก้ไข</p>
                    </div>
                        ...
                        <table class="responsive-table w-full border border-collapse text-xs md:text-sm">
                            <thead>
                                <tr class="bg-gray-200 whitespace-nowrap">
                                    ...
                                    <th class="col-lastname border px-2 py-1">นามสกุล</th>
                                    ...
                                    <th class="col-date border px-2 py-1">วัน/เวลาที่ให้เเก้ไข</th>
                                    <th class="col-dateedit border px-2 py-1">วัน/เวลา เเก้ไขสำเร็จ</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(partner, index) in paginatedData" :key="partner._id"
                                    ...
                                    <td class="col-lastname border px-2 py-1">{{ partner.lastname }}</td>
                                    ...
                                    <td class="col-dateedit border px-2 py-1">สถานะการเเก้ไข</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="mt-3 flex flex-wrap justify-center gap-2 px-2">
                        ...
                        <button v-for="page in totalPages" :key="page" @click="currentPage = page"
                            ...
                            :class="{ 'bg-emerald-700 text-white': currentPage === page }">
                            {{ page }}
                        </button>
