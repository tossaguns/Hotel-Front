        ...
        <div class="flex-1 md:pl-4 md:pr-2 py-4 md:py-3 mt-16 md:mt-0 transition-all duration-300"
            ...
            <div>
                ...
                <div class="bg-white rounded-lg pb-6">
                    ...
                    <div class="text-center pt-4 text-4xl font-bold text-emerald-700 rounded-t-lg">
                        <p> Check In </p>
                    </div>
                ...
                <div class="flex justify-center mt-5 mb-5 ">
                    <button @click="navigateBackToMain"
                        class="text-white bg-red-700 py-2 px-3 rounded-lg hover:bg-red-500">ย้อนกลับ</button>
                </div>
            </div>
