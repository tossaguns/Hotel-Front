        ...
        <div class="flex-1 md:pl-4 md:pr-2 py-4 md:py-3 mt-16 md:mt-0 transition-all duration-300"
            ...
            <div>
                ...
                <div class="bg-white rounded-lg pb-6">
                    ...
                    <div class="text-center pt-4 pb-4 px-2 text-4xl font-bold bg-amber-400 rounded-t-lg">
                        <p>หน้าหลัก Check In - Check Out</p>
                    </div>

                    <div class="flex justify-center pt-7 mb-5">
                        <button @click="navigateToCheckIn"
                            class="rounded-lg px-2 py- text-lg hover:bg-amber-300 shadow-lg">ดูข้อมูล Check IN</button>
                        <p class="text-2xl px-2 text-gray-400 font-bold">|</p>
                        <button @click="navigateToCheckOut"
                            class="rounded-lg px-2 py-1 text-lg hover:bg-amber-300 shadow-lg">ดูข้อมูล Check
                            Out</button>
                    </div>
                            ...
                            <tbody>
                                <tr v-for="(item, index) in paginatedData" :key="index"
                                    ...
                                    <td class="border px-2 py-1 text-center">
                                        <button class="bg-blue-600 hover:bg-blue-400 text-white px-3 py-1 rounded">
                                            แก้ไข
                                        </button>
                                    </td>
