<template>
  <div class=" mt-32">
    <div ref="heading" :class="[
      'md:text-2xl text-xl font-bold text-center md:text-left text-red-700 italic mb-4 transition-all duration-1000 ease-in-out',
    ...
    <div ref="container" class="px-4" :class="[
      ...
      <div>
        <p>
          <span class="font-bold">สถานที่</span> ดำเนินโครงการทั่วประเทศ โดยมีศูนย์กลางที่จังหวัดนำร่อง 10 แห่ง
      ...
      <div class="mt-4 md:text-center ">
        <p class="indented-8 md:indent-0">
